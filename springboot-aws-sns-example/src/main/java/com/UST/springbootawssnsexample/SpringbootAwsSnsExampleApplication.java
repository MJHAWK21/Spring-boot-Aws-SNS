package com.UST.springbootawssnsexample;
...
public class SpringbootAwsSnsExampleApplication {
	...
	String TOPIC_ARN="arn:aws:sns:ap-south-1:085117959503:javafullstack-topic" ;
	...
	private String buildEmailBody(){
		return "Dear Employee ,\n" +
				"\n" +
				"\n" +
				"Connection down Trivendram."+"\n"+
				"All the servers in Trivendram Data center are not accessible. We are working on it ! \n" +
